...
This repository and the included specification are provided for public reference. No license is granted to copy, modify, distribute, sublicense, or use the work except with prior written permission from the copyright holder.
